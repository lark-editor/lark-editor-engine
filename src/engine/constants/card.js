export const CARD_KEY = 'data-lake-card'
...
export const CARD_SELECTOR = "div[".concat(CARD_KEY, "],span[").concat(CARD_KEY, "]")
export const READY_CARD_SELECTOR = "div[".concat(READY_CARD_KEY, "],span[").concat(READY_CARD_KEY, "]")
export const CARD_LEFT_SELECTOR = "span[".concat(CARD_ELEMENT_KEY, "=left]")
export const CARD_CENTER_SELECTOR = "div[".concat(CARD_ELEMENT_KEY, "=center],span[").concat(CARD_ELEMENT_KEY, "=center]")
